...
- **Working grammars in the repo**:
  ...
  - `grammars/lefdef.rawast` — unified LEF + DEF 5.8 grammar.
    ...
    **LEF side** — base-spec (5.8) coverage, less LEF58_*
    ...
    ihp-sg13g2 / NanGate / gf180) covering both cell LEFs and
    tech LEFs, `parse → save → reparse` is **263 / 263
    structurally equivalent**, in addition to a synthetic
    spec-coverage fixture (`lef_spec_coverage.lef`) that
    exercises every spec clause.
